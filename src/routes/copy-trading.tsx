...
export const Route = createFileRoute("/copy-trading")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Strategy providers, followers and copy-trading allocations." },
    ],
  }),
  component: () => (
    <ClientShell>
      <InteractiveTab render={({ openDrawer }) => <CopyTradingTab openDrawer={openDrawer} />} />
    </ClientShell>
  ),
});
